package com.sample.imagefeaturelibrary.imagedetails.domain.sampledata

import com.sample.imagefeaturelibrary.common.data.model.GalleryItem

/**
 *  This is sample data to test ImageDetailUseCaseTest
 */
object ImageDetailTestSampleData {
    ...
    val sampleGalleryItem = listOf(
        ...
        /* This is invalid item as media type is not image*/
        GalleryItem(
